const fantomSFC = [
	...
	},
	{
		...
		outputs: [
			...
			{ internalType: 'uint256', name: 'totalBaseRewardWeight', type: 'uint256' },
			{ internalType: 'uint256', name: 'totalTxRewardWeight', type: 'uint256' },
	...
	},
	{
		...
		name: 'getLockupInfo',
		outputs: [
			{ internalType: 'uint256', name: 'lockedStake', type: 'uint256' },
	...
	},
	{
		...
		outputs: [
			{ internalType: 'uint256', name: 'lockupExtraReward', type: 'uint256' },
			{ internalType: 'uint256', name: 'lockupBaseReward', type: 'uint256' },
			{ internalType: 'uint256', name: 'unlockedReward', type: 'uint256' },
		],
		payable: false,
		stateMutability: 'view',
		type: 'function',
	...
	},
	{
		...
		inputs: [
			{ internalType: 'address', name: 'delegator', type: 'address' },
			{ internalType: 'address', name: 'validatorAuth', type: 'address' },
	...
	},
	{
		...
		inputs: [
			...
			{ internalType: 'uint256', name: 'lockedStake', type: 'uint256' },
			{ internalType: 'uint256', name: 'lockupFromEpoch', type: 'uint256' },
			{ internalType: 'uint256', name: 'lockupEndTime', type: 'uint256' },
			{ internalType: 'uint256', name: 'lockupDuration', type: 'uint256' },
			{ internalType: 'uint256', name: 'earlyUnlockPenalty', type: 'uint256' },
