export const decentralandBuyAbi = [
  {
    inputs: [
  ...
  {
    inputs: [
      { internalType: "address", name: "_newFeesCollector", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_publicationFee", type: "uint256" },
    ],
...
export default decentralandBuyAbi;
