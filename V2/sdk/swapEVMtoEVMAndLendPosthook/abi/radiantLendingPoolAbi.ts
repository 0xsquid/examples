const radiantLendingPoolAbi = [
	...
	},
	{
		inputs: [],
		name: 'leverager',
		outputs: [{ internalType: 'contract ILeverager', name: '', type: 'address' }],
		stateMutability: 'view',
		type: 'function',
	},
	{
	...
	{
		inputs: [{ internalType: 'contract ILeverager', name: '_leverager', type: 'address' }],
		name: 'setLeverager',
		outputs: [],
		stateMutability: 'nonpayable',
		type: 'function',
...
export default radiantLendingPoolAbi;
